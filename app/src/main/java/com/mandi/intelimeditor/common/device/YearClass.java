 ...
 */
package com.mandi.intelimeditor.common.device;
...
public class YearClass {
    ...
    public static final int CLASS_2013 = 2013; // =<2G内存
    public static final int CLASS_2014 = 2014; // 2-4G内存
    public static final int CLASS_2015 = 2015; // 4-6G内存
    public static final int CLASS_2016 = 2016; // 6-8G内存
    public static final int CLASS_2019 = 2019; // 8G以上

    public static final int PERFORMANCE_0G_2G = CLASS_2013; // <2G内存
    public static final int PERFORMANCE_2G_4G = CLASS_2014; // 2 <= x < 4G内存
    public static final int PERFORMANCE_4G_6G = CLASS_2015; // 4 <= x < 6G内存
    public static final int PERFORMANCE_6G_8G = CLASS_2016; // 6 <= x < 8G内存
    public static final int PERFORMANCE_8G_UP = CLASS_2019; // 8G及以上
    ...
    private static int categorizeByYear2016Method(Context c) {
        ...
        return totalRam < 8 * 1024 * MB ? CLASS_2016 : CLASS_2019;
    }
