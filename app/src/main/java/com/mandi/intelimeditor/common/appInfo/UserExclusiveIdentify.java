...
public class UserExclusiveIdentify {
    ...
    private static String getIMEI() {
        String szImei = "";
        try {
            TelephonyManager TelephonyMgr = (TelephonyManager) IntelImEditApplication.appContext.getSystemService(TELEPHONY_SERVICE);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && TelephonyMgr != null) {
    ...
    private static String getTheAndroidID() throws Exception {
        String m_szAndroidID = Settings.Secure.getString(IntelImEditApplication.appContext.getContentResolver(), Settings.Secure.ANDROID_ID);
    ...
    private static String getWLAN_MAC() throws Exception {
        WifiManager wm = (WifiManager) IntelImEditApplication.appContext.getSystemService(Context.WIFI_SERVICE);
